...
export function Footer() {
  return (
    <footer className="mt-auto bg-main bg-cover ">
      <div className="bg-black bg-opacity-30 px-10 py-20 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-0 items-start justify-items-center text-center md:text-left md:text-lg text-white">
        <div>
